var $7Mkj4$webrtcadapter = require("webrtc-adapter");
...
$parcel$export(module.exports, "audio", () => $dc2d1add750c9ef6$export$592b77e6034db746);
$parcel$export(module.exports, "video", () => $dc2d1add750c9ef6$export$5f8d3589eb8441ca);
$parcel$export(module.exports, "screen", () => $dc2d1add750c9ef6$export$be623a1d3e871e62);
$parcel$export(module.exports, "default", () => $dc2d1add750c9ef6$export$2e2bcd8739ae039);
var $6570bb26ee0da8f2$exports = {};

$parcel$export($6570bb26ee0da8f2$exports, "Media", () => $6570bb26ee0da8f2$export$7fc53215244aec38, (v) => $6570bb26ee0da8f2$export$7fc53215244aec38 = v);
var $dc4f77743a61ac92$var$EventTarget = /** @class */ function() {
...
var $dc4f77743a61ac92$export$2e2bcd8739ae039 = $dc4f77743a61ac92$var$EventTarget;


var $925c9057c63c002e$export$31da179f3c64051c = /** @class */ function() {
...
var $925c9057c63c002e$export$2e2bcd8739ae039 = $925c9057c63c002e$export$31da179f3c64051c;



var $491f60eff08796ee$var$webRTCAdapter = //@ts-ignore
(0, ($parcel$interopDefault($7Mkj4$webrtcadapter))).default || (0, ($parcel$interopDefault($7Mkj4$webrtcadapter)));
var $491f60eff08796ee$export$6c0517834721cef7 = new /** @class */ (function() {
    function class_1() {
        this.isIOS = [
            "iPad",
            "iPhone",
    ...
    class_1.prototype.getBrowser = function() {
        return $491f60eff08796ee$var$webRTCAdapter.browserDetails.browser;
    };
    class_1.prototype.getVersion = function() {
        return $491f60eff08796ee$var$webRTCAdapter.browserDetails.version || 0;
    };
    class_1.prototype.isUnifiedPlanSupported = function() {
        var browser = this.getBrowser();
        var version = $491f60eff08796ee$var$webRTCAdapter.browserDetails.version || 0;
...
var $6570bb26ee0da8f2$var$__extends = undefined && undefined.__extends || function() {
...
var $6570bb26ee0da8f2$var$__assign = undefined && undefined.__assign || function() {
    $6570bb26ee0da8f2$var$__assign = Object.assign || function(t) {
    ...
    return $6570bb26ee0da8f2$var$__assign.apply(this, arguments);
};
var $6570bb26ee0da8f2$var$__awaiter = undefined && undefined.__awaiter || function(thisArg, _arguments, P, generator) {
...
var $6570bb26ee0da8f2$var$__generator = undefined && undefined.__generator || function(thisArg, body) {
    var _ = {
        label: 0,
        sent: function() {
            if (t[0] & 1) throw t[1];
...
var $6570bb26ee0da8f2$export$7fc53215244aec38 = /** @class */ function(_super) {
    $6570bb26ee0da8f2$var$__extends(Media, _super);
    function Media(mediaType, option) {
        ...
        if ((0, $491f60eff08796ee$export$6c0517834721cef7).isUnifiedPlanSupported()) _this_1.setMediaType(mediaType).setConfig(option);
        else _this_1.emit("error", {
            type: "constructor",
            message: "".concat((0, $491f60eff08796ee$export$6c0517834721cef7).toString())
        });
        return _this_1;
    }
    ...
    Media.prototype.setMediaStream = function(constraints) {
        return $6570bb26ee0da8f2$var$__awaiter(this, void 0, void 0, function() {
            var _constraints, mediaType, _a, _b, err_1;
            return $6570bb26ee0da8f2$var$__generator(this, function(_c) {
                switch(_c.label){
                    case 0:
     ...
     */ Media.prototype.setMediaStreamConstraints = function(constraints) {
        var _constraints = $6570bb26ee0da8f2$var$__assign($6570bb26ee0da8f2$var$__assign({}, this.getMediaStreamConstraints()), constraints);
     ...
     */ Media.prototype.setMediaRecorderOptions = function(options) {
        var _options = $6570bb26ee0da8f2$var$__assign($6570bb26ee0da8f2$var$__assign({}, this.getMediaRecorderOptions()), options);
    ...
    Media.prototype.create = function() {
        return $6570bb26ee0da8f2$var$__awaiter(this, void 0, void 0, function() {
            var media;
            return $6570bb26ee0da8f2$var$__generator(this, function(_a) {
                switch(_a.label){
                    case 0:
    ...
    Media.prototype.setSoundMeter = function(mediaStream) {
        try {
            ...
            this.soundMeter = new (0, $925c9057c63c002e$export$2e2bcd8739ae039)(audioContext);
    ...
    return Media;
}((0, $dc4f77743a61ac92$export$2e2bcd8739ae039));
var $6570bb26ee0da8f2$export$2e2bcd8739ae039 = $6570bb26ee0da8f2$export$7fc53215244aec38;


function $dc2d1add750c9ef6$export$592b77e6034db746(option) {
    var audio = new (0, $6570bb26ee0da8f2$exports.Media)("audio", option);
    return audio;
}
function $dc2d1add750c9ef6$export$5f8d3589eb8441ca(option) {
    var video = new (0, $6570bb26ee0da8f2$exports.Media)("video", option);
    return video;
}
function $dc2d1add750c9ef6$export$be623a1d3e871e62(option) {
    var screen = new (0, $6570bb26ee0da8f2$exports.Media)("screen", option);
    return screen;
}
var $dc2d1add750c9ef6$export$2e2bcd8739ae039 = (0, $6570bb26ee0da8f2$exports.Media);
