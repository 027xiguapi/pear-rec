...
const EditImage = (props) => {
  ...
  useEffect(() => {
    props.imgUrl && initImageEditor(props.imgUrl);
  }, [props.imgUrl]);

  function initImageEditor(imgUrl) {
    ...
    (document.getElementsByClassName('tui-image-editor-main')[0] as any).style.top = '45px'; // 图片距顶部工具栏的距离
    (
      document.getElementsByClassName('tie-btn-reset tui-image-editor-item help')[0] as any
